...
play.addEventListener('click', function () {
  ...
  setTimeout(() => {
    ...
    twoPlayers.src = `./2robots_Artboard\ 7.png`;
    threePlayers.src = `./2robots2_Artboard\ 7.png`;
    fourPlayers.src = `./2robots3_Artboard\ 7.png`;
    ...
    function startGame(numChosen) {
      ...
      setTimeout(() => {
        ...
        function listPlayers(playerSection, playerIcon, playerScore, playerScoreNum, imgSrc) {

          playerSection.classList.add('player-section');
          playerIcon.classList.add('player-section-item');
          playerScore.classList.add('player-section-item');

          playerIcon.src = `${imgSrc}`;
        ...
        if (numOfPlayers === 2) {
          ...
          listPlayers(player1Section, player1Icon, player1Score, player1ScoreNum, './Robots\ Patterns2_Artboard\ 7.png');
          listPlayers(player2Section, player2Icon, player2Score, player2ScoreNum, './Robots\ Patterns_Artboard\ 7.png');
          ...
          listPlayers(player1Section, player1Icon, player1Score, player1ScoreNum, './Robots\ Patterns2_Artboard\ 7.png');
          listPlayers(player2Section, player2Icon, player2Score, player2ScoreNum, './Robots\ Patterns_Artboard\ 7.png');
          listPlayers(player3Section, player3Icon, player3Score, player3ScoreNum, './Robots\ Patterns3_Artboard\ 7.png');
          ...
          listPlayers(player2Section, player2Icon, player2Score, player2ScoreNum, './Robots\ Patterns_Artboard\ 7.png');
          listPlayers(player3Section, player3Icon, player3Score, player3ScoreNum, './Robots\ Patterns3_Artboard\ 7.png');
          listPlayers(player4Section, player4Icon, player4Score, player4ScoreNum, './Robots\ Patterns4_Artboard\ 7.png');
        ...
        askQuestion.addEventListener('click', function () {
          ...
          askQuestion.style.pointerEvents = 'none';
          ...
          askedQuestion.style.pointerEvents = 'none';
          setTimeout(() => {
            askedQuestion.style.pointerEvents = 'auto';
          }, 1500);
          ...
          function incrementScore() {
              if(turn === 0) {
                  ...
                  turn = 1;
                  gameScreen.style.backgroundImage = 'url(./litBlueBackground.jpg)';
                  ...
                  if(numOfPlayers === 2) {
                    turn = 0;
                    gameScreen.style.backgroundImage = 'url(./litOrangeBackground.jpg)';
                    askQuestion.style.backgroundColor = 'rgb(255, 174, 0)';
                  } else {
                    turn = 2;
                    gameScreen.style.backgroundImage = 'url(./litGreenBackground.jpg)';
                  ...
                  if(numOfPlayers === 3) {
                    ...
                    turn = 3;
                    gameScreen.style.backgroundImage = 'url(./litPurpleBackground.jpg)';
